...
import com.meguillaume.customviewindrawer.MyCustomView;
import com.meguillaume.customviewindrawer.R;
...
public class CustomViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myView = (MyCustomView) rootView.findViewById(R.id.view);
        ...
        myView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                myView.setSquareText("Naruto: Nine Tail Fox");
            }
        });
        return rootView;
    }
